<div class="page">
  <div class="page-header">
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= base_url() ?>Masuk">Barang Masuk</a></li>
    ...
    <div class="col-lg-6">
      ...
      <div class="panel">
        <div class="panel-body">
          <form action='<?php echo base_url(). 'Masuk/tambah_aksi'; ?>' method='POST' id="exampleFullForm"
            autocomplete="off">
            ...
            <div class="form-group row">
              <label class="col-xl-12 col-md-3 form-control-label">Tanggal Masuk
                <span class="required">*</span>
              </label>
              <div class=" col-xl-12 col-md-9">
