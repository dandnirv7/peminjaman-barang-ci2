    ...
    <div class="col-lg-6">
      ...
      <div class="panel">
        <div class="panel-body">
          <form action='<?php echo base_url(). 'Pinjam/update'; ?>' method='POST' id="exampleFullForm"
            autocomplete="off">
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="text" class="form-control" name="id_pinjam" placeholder="1" value="<?=$ubah->id_pinjam?>"
                  required="">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="text" class="form-control" name="peminjam" value="<?=$ubah->peminjam?>" required="">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="date" class="form-control" name="tgl_pinjam" value="<?=$ubah->tgl_pinjam?>" required="">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="text" class="form-control" name="jml_barang" value="<?=$ubah->jml_barang?>" required="">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <?php
						...
						{
							if($prodi->id_barang==$ubah->id_barang){
					?>
                <div>
            ...
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="date" class="form-control" name="tgl_kembali" value="<?=$ubah->tgl_kembali?>">
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class=" col-xl-12 col-md-9">
                <input type="text" class="form-control" name="kondisi" value="<?=$ubah->kondisi?>" placeholder="Baru">
              </div>
            </div>
