  <div class="page">
    <div class="page-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="<?= base_url() ?>Keluar">Barang Keluar</a></li>
      ...
      <div class="col-lg-6">
        ...
        <div class="panel">
          <div class="panel-body">
            <form action='<?php echo base_url(). 'Keluar/tambah_aksi'; ?>' method='POST' id="exampleFullForm"
              autocomplete="off">
              ...
              <div class="form-group row">
                ...
                <div class=" col-xl-12 col-md-9">
                  ...
                  <div>
                    <div class="radio-custom radio-primary">
                      <input type="radio" id="<?=$prodi->id_supplier?>" name="id_supplier"
                        value="<?=$prodi->id_supplier?>" required="">
                      <label for="<?=$prodi->id_supplier?>"><?=$prodi->nama_supplier?></label>
                    </div>
                  </div>
                  <?php
						}
              ...
              <div class="form-group row">
                <label class="col-xl-12 col-md-3 form-control-label">Tanggal Keluar
                  <span class="required">*</span>
                </label>
                <div class=" col-xl-12 col-md-9">
              ...
              <div class="form-group row">
                ...
                <div class=" col-xl-12 col-md-9">
                  <input type="number" class="form-control" name="jml_keluar" required="">
                </div>
              </div>
